...
import re
stanza.download('ru')
file = pd.read_csv('/Users/lidiiamelnyk/Documents/korrespondent/hatespeech_korrespondent_ru.csv', header = 0, sep = ';', encoding='utf-8-sig',
...
nlp = stanza.Pipeline('ru', processors='tokenize, pos, lemma', tokenize_no_ssplit = True) #create nlp pipeline
myfile = open('/Users/lidiiamelnyk/Documents/stopwords_ru.txt', "r", encoding = 'utf-8-sig') #upload the stopwords
content = myfile.read()
...
with open('/Users/lidiiamelnyk/Documents/korrespondent/lemmatized_dataframe_ru.csv', 'w+', encoding='utf-8-sig', newline='') as my_file:
